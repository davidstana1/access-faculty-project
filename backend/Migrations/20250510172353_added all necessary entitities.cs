...
{
    /// <inheritdoc />
    public partial class addedallnecessaryentitities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BluetoothSecurityCode = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Employees_AspNetUsers_ApprovedById",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VehicleNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsWithinSchedule = table.Column<bool>(type: "bit", nullable: false),
                    WasOverridden = table.Column<bool>(type: "bit", nullable: false),
                    OverrideUserId = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AccessSchedules_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastAccessEmployeeId = table.Column<int>(type: "int", nullable: true),
                    LastDirection = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.LastAccessEmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccessSchedules_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employees_BluetoothSecurityCode",
                table: "Employees",
                column: "BluetoothSecurityCode",
                unique: true);
